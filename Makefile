...
PARSER = parser.c parser_utils.c parser_helper.c parser_nodes.c \
	parser_cmd.c parser_io.c parser_redir.c free_ast.c
...
EXEC = exec.c exec_utils.c exec_heredoc.c exec_cmd.c exec_path.c \
	exec_redir.c exec_open.c exec_handler.c
...
# error utils
ERR = set_exit_status.c error_expander.c error_builtin.c error_exec.c \
